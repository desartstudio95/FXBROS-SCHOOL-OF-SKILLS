...
import { Video, Calendar, Loader2, AlertCircle, X } from 'lucide-react';
      ...
      <div className="animate-fadeIn p-4 h-full flex flex-col">
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-xl font-bold text-white flex items-center gap-3">
            ...
            {selectedSession.summary || 'Sessão ao Vivo'}
          </h2>
          <button 
        ...
        <div className="flex-1 bg-slate-900 border border-slate-800 rounded-xl overflow-hidden shadow-2xl relative min-h-[50vh]">
          {selectedSession.hangoutLink ? (
             <iframe 
               src={selectedSession.hangoutLink} 
             ...
             <div className="flex items-center justify-center h-full text-slate-500 flex-col gap-4">
                 ...
                 <p>O link da sessão não está disponível para este evento.</p>
             </div>
          )}
        </div>
      </div>
